...
export const AirQualityHotSchema = SchemaFactory.createForClass(AirQualityHot);

// High-performance indexes for hot data
AirQualityHotSchema.index({ timestamp: -1 });
AirQualityHotSchema.index({ timestamp: -1, aqi: -1 });
